...
urlpatterns = [
    ...
    path('subscribe/1', SubscribCategoryCreate.as_view(), name='subscribe_cat'),
    path('subscribe/2', SubscribCategoryCreate.as_view(), name='subscribe_cat'),
    path('subscribe/3', SubscribCategoryCreate.as_view(), name='subscribe_cat'),
    path('subscribe/4', SubscribCategoryCreate.as_view(), name='subscribe_cat'),
]
